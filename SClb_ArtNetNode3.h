...
#ifndef _SClb_ArtNetNode3_h
#define _SClb_ArtNetNode3_h
...
class SCArtNet3 : public SClb_Arduino_DMXEthernet {
...
public:
	...
	*/
	SCArtNet3(IPAddress address, IPAddress subnet_mask, uint8_t* buffer);


	/*!
	* @brief destructor for SCArtNet3 (frees packet buffer if allocated with constructor)
	*/
	~SCArtNet3(void);
...
#endif // ifndef SClb_ArtNetNode3_H
